...
const nicheAliases = {
  ...
  immobilier: ["immobilier", "agence immobiliere", "agence immobilière", "real estate", "patrimoine"],
  "local-services": ["service local", "depannage", "dépannage", "intervention", "artisan", "habitat"],
  "car-rental": ["location de voiture", "location voiture", "voiture", "vehicule", "véhicule", "auto", "car rental"],
