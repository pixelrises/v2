...
export const defaultRoutingRules: Record<AITaskType, AIRoutingRule> = {
  ...
  creator_image_concept: {
    ...
    reason: "Claude Design prepare le brief visuel, la direction artistique et les contraintes avant generation image.",
  },
  creator_premium_image: {
    taskType: "creator_premium_image",
    provider: "pollojourney",
    fallbackProvider: "cloud-design",
  ...
  creator_ad_creative: {
    ...
    reason: "Pollojourney est utile pour publicites produit et visuels promotionnels haut de gamme apres validation utilisateur.",
  },
  code_generation: {
...
export const routingModeOverrides: Record<AIExecutionMode, Partial<Record<AITaskType, AIProviderId>>> = {
  ...
  qualite: {
    ...
    creator_image_concept: "cloud-design",
  ...
  cout_optimise: {
    ...
    creator_premium_image: "cloud-design",
