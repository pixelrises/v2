-- Repair Product Lab V1 admin tables and reload PostgREST schema cache.
-- Safe/idempotent: creates missing V1 Product Lab tables only.
-- Does not touch V2 Product Lab data, users, credits, payments, Stripe, generated sites, or secrets.
